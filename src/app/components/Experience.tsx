...
export default function Experience() {
    return (
        <div id="work-experience" className="py-16 max-w-4xl mx-auto px-4 scroll-mt-[44px] lg:scroll-mt-[68px]">
            <h1 className="mb-12 text-4xl font-bold text-center text-gray-800">Experience</h1>
            
            <div className="space-y-12">
                {/* Current Position */}
                <div className="flex flex-col md:flex-row md:items-start gap-6 border-l-4 border-indigo-400 pl-6">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-indigo-600 font-semibold text-lg mb-1">CodeLab FZC LLC</p>
