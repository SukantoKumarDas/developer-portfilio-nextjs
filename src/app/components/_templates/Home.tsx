...
import { GithubIcon, Linkedin, MailIcon, WheatIcon } from "lucide-react";

export default function Home() {
    return (
        <div id="home" className="text-white font-bold sm:grid-cols-2 bg-[url('/assets/images/top-bg.jpg')] h-auto">
            <div className="max-w-7xl mx-auto relative">
                <div className="px-8 grid grid-cols-1 sm:grid-cols-2">
                    <div className="col-span-1">
                        <div className="mt-10 sm:mt-0 py-0 sm:py-50 flex flex-col justify-center items-center sm:items-start space-y-6">
                            <span className="text-xl sm:text-5xl text-lime-400">Hello I&apos;m</span>
                            <h1 className="text-3xl sm:text-5xl mb-15 uppercase">Sukanto Kumar Das</h1>
                            ...
                            <div className="flex flex-wrap gap-4 mt-4">
                                <div className="px-4 py-2 border border-lime-400 rounded-md text-center">
                ...
                <div className="invisible md:visible absolute right-30 top-30 flex flex-row gap-2">
